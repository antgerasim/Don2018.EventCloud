...
export class EventServiceProxy {
     ...
     * @return Success
     */
    getEvents(includeCancelledEvents: boolean): Observable<ListResultDtoOfEventListDto> {
        let url_ = this.baseUrl + "/api/services/app/Event/GetEvents?";
        if (includeCancelledEvents === undefined || includeCancelledEvents === null)
            throw new Error("The parameter 'includeCancelledEvents' must be defined and cannot be null.");
        else
            url_ += "IncludeCancelledEvents=" + encodeURIComponent("" + includeCancelledEvents) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ListResultDtoOfEventListDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfEventListDto>><any>Observable.throw(response_);
        });
    }

    protected processGetEvents(response: Response): Observable<ListResultDtoOfEventListDto> {
        const status = response.status;
        ...
        return Observable.of<ListResultDtoOfEventListDto>(<any>null);
    }

    /**
     * @return Success
     */
    getDetail(id: string): Observable<EventDetailOutput> {
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<EventDetailOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<EventDetailOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetDetail(response: Response): Observable<EventDetailOutput> {
        const status = response.status;
        ...
        return Observable.of<EventDetailOutput>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: CreateEventInput): Observable<void> {
     ...
     * @return Success
     */
    cancel(input: EntityRequestInputOfGuid): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Event/Cancel";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCancel(response: Response): Observable<void> {
        const status = response.status;
     ...
     * @return Success
     */
    register(input: EntityRequestInputOfGuid): Observable<EventRegisterOutput> {
        let url_ = this.baseUrl + "/api/services/app/Event/Register";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<EventRegisterOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<EventRegisterOutput>><any>Observable.throw(response_);
        });
    }

    protected processRegister(response: Response): Observable<EventRegisterOutput> {
        const status = response.status;
        ...
        return Observable.of<EventRegisterOutput>(<any>null);
    }
}
...
export class EntityRequestInputOfGuid implements IEntityRequestInputOfGuid {
    ...
    constructor(data?: IEntityRequestInputOfGuid) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): EntityRequestInputOfGuid {
        let result = new EntityRequestInputOfGuid();
        result.init(data);
        return result;
    }
...
export interface IEntityRequestInputOfGuid {
    id: string;
}
